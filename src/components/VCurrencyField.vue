<template>
  <v-text-field ref="field" :prefix="prefix" v-model="model" @focus="onFocus" @keyup="onKeyUp"
    :error-messages="errorMessages" v-bind="$attrs" @change="onChange" @blur="onBlur" :suffix="suffix">
  </v-text-field>
</template>
