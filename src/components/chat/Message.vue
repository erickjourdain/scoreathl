<template>
  <div class="sc-message">
    <div class="sc-message--content" :class="{
      ...
      }" v-tooltip="message.author.nom"></div>
      -->
      <athlete-avatar :avatar="message.author.avatar" :tooltip="message.author.nom" v-if="!message.author.me && message.type !== 'system'"/>
  ...
  <!--
  <div class="sc-message">
    <v-layout class="sc-message--content align-center" :class="{
        'text-xs-right': message.author.me,
        'justify-end': message.author.me,
        'justify-start': !message.author.me && message.type !== 'system',
        'justify-center': message.type === 'system'
      }" row wrap>
      <v-flex xs12>
        <span class="caption">{{ $moment(message.createdAt).fromNow() }}</span>
      </v-flex>
      <v-flex xs12>
        <athlete-avatar :avatar="message.author.avatar" :tooltip="message.author.nom" v-if="!message.author.me && message.type !== 'system'"/>
        <TextMessage v-if="message.type === 'text'" :data="message.data" :messageColors="determineMessageColors()" :messageStyling="messageStyling" />
